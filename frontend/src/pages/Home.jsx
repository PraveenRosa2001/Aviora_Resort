...
//   /* Top Rated & Discounted Showcase Villas */
//   const allVillas = apiVillas.length > 0 ? apiVillas : VILLAS_DATA;
//   const showcaseVillas = [...allVillas]
//     .sort((a, b) => (b.rating || 4.9) - (a.rating || 4.9))
//     .slice(0, 3);
//   const villaLeft = showcaseVillas[0] || VILLAS_DATA[0];
//   const villaTopRight = showcaseVillas[1] || VILLAS_DATA[1];
//   const villaBottomRight = showcaseVillas[2] || VILLAS_DATA[2];
